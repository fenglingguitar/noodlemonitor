	...
	<div class="container">
		...
		<div class="menuer">
            <ul id="menu">
                ...
                <li><a href="#">常规监控</a>
                    <ul>
						<li><a href="#" onclick="javascript:addTab('mainframe_1_1_1', '超时次数', '<%=request.getContextPath()%>/view/monitor/server/overtime/overtime_chart.jsp');">超时次数</a></li>
						<li><a href="#" onclick="javascript:addTab('mainframe_1_1_2', '平均响应时间', '<%=request.getContextPath()%>/view/monitor/server/avgtime/avgtime_chart.jsp');">平均响应时间</a></li>
						<li><a href="#" onclick="javascript:addTab('mainframe_1_1_3', '失败次数', '<%=request.getContextPath()%>/view/monitor/server/success/success_chart.jsp');">错误次数</a></li>
                   </ul>
                </li>
            </ul>
        </div>
